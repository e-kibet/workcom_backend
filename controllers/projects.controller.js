...
exports.create = async (req, res) => {
    try {
        await service.project.create(req, res).then(async (results) => {
            res.status(200).json({ status: true, status_code: 200, status_message: 'Project created successfully' });
        }, async (error) => {
...
exports.fetch = async (req, res) => {
    try {
        await service.project.fetch(req).then(async (results)=> {
